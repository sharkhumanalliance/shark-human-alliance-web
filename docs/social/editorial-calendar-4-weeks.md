...
`Bureau bulletin - Form FIN-1 (Pre-Beach Snack-Denial Declaration) is now in circulation. Filing is voluntary. The Bureau strongly recommends it anyway.`
...
| Day | Channel | Format | Pillar | Post | CTA |
| --- | --- | --- | --- | --- | --- |
| Tue 20:00 | IG + FB | IMG | Bureau | Finnley field report | Comment softly |
| Thu 12:30 | IG + FB | TXT/IMG | Mission | 450M years serious moment | Save |
| Sat 10:30 | IG + FB | IMG | Bureau | Letter to the sharks returned | Share |
| Wed or Fri | Stories | Story | Character | Finnley statement draft / Luna redaction | Reply |

### 3.1 Field Report

Graphic copy:

`09:14 - Subject arrived at beach. Confidence: high. Documentation: none. Snack-denial paperwork: unfiled. Recommendation: gentle administrative reminder. - F.M.`

Caption:

`Finnley filed a field report. Luna is reviewing it.`
...
`A factual entry, not a joke. Sharks have had better centuries.`

### 3.3 Ocean Did Not Reply

Caption:

`The Bureau attempted to notify the shark community. The ocean did not reply.`

Visual:

Cream envelope addressed:
...
| Thu 12:30 | IG + FB | IMG/CAR | Character | Luna quarterly statement redacted | Comment |
| Sat 10:30 | IG + FB | IMG/VID | Product bridge | First Wanted CTA | Open a Wanted case |
| Wed or Fri | Stories | Story | Bureau | Mini poll / stamp / case number | Open case teaser |
...
Official document with most lines redacted. Visible fragments:
...
Wanted poster preview or case-file desk scene.
