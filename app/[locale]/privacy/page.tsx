...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: t("description"),
      type: "website",
      images: [{ url: "/mascots/homepage-hero-og.jpg", width: 1200, height: 630 }],
    },
    twitter: {
      card: "summary_large_image",
      title: t("title"),
      description: t("description"),
      images: ["/mascots/homepage-hero-og.jpg"],
    },
  };
}
            ...
            <div className="space-y-5">
              {sections.map((section) => (
                <article
                  key={section}
                  data-reveal
                  className="rounded-2xl border border-[var(--border)] bg-white p-6 shadow-sm sm:p-7"
                >
