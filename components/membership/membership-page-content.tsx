  ...
  const tierCards = [
    {
      ...
      features: [homeTierT("protectedFeatures.0"), homeTierT("protectedFeatures.1"), homeTierT("protectedFeatures.2"), homeTierT("protectedFeatures.3")],
    ...
    },
    {
      ...
      features: [homeTierT("nonsnackFeatures.0"), homeTierT("nonsnackFeatures.1"), homeTierT("nonsnackFeatures.2"), homeTierT("nonsnackFeatures.3")],
    ...
    },
    {
      ...
      features: [homeTierT("businessFeatures.0"), homeTierT("businessFeatures.1"), homeTierT("businessFeatures.2"), homeTierT("businessFeatures.3")],
